...
public class MonoBehaviourExtended : MonoBehaviour
{
    ...
    /// <summary>
    /// Deletes all of the childrens of the passed <c>go</c>.
    /// </summary>
    /// <param name="go"> The game object whose children to delete.</param>
    protected static void DeleteChildren(GameObject go)
    {
        var t = go.transform;
